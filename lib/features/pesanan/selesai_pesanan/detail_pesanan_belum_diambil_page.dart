...
class DetailPesananBelumDiambilPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Status
    final statusColor = Colors.orange[700]!;
    ...
    if (listItem.isEmpty) {
      listItem.add({"nama": "Item Kosong", "tipe": "", "jumlah": 0, "harga": 0, "hargaTotal": 0});
    }
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      if (onKonfirmasiDiambil != null) const SizedBox(width: 13),
