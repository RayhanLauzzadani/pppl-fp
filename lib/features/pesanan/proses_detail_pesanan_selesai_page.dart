...
import 'package:laundryin/features/pesanan/selesai_pesanan/selesai_pesanan_page.dart';
...
class _ProsesDetailPesananSelesaiPageState
  ...
  void _initItemList() {
    ...
    // Dari barangList (barang satuan/custom)
    ...
    if (fallback.isEmpty) {
      fallback.add({"nama": "Item Kosong", "jumlah": "0", "konfirmasi": true});
    }
